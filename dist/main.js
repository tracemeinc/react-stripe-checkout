...
ReactStripeCheckout.propTypes = {
  ...
  token: function token(props) {
    ...
    return !props.source && (_PropTypes$func = _propTypes2.default.func).isRequired.apply(_PropTypes$func, [props].concat(args));
  },
  ...
  source: function source(props) {
    ...
    return !props.token && (_PropTypes$func2 = _propTypes2.default.func).isRequired.apply(_PropTypes$func2, [props].concat(args));
  },
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onScriptLoaded = function () {
    if (!ReactStripeCheckout.stripeHandler) {
      ReactStripeCheckout.stripeHandler = StripeCheckout.configure({
        key: _this3.props.stripeKey
      });
      if (_this3.hasPendingClick) {
        _this3.showStripeDialog();
      }
    }
  };
  ...
  this.onScriptError = function () {
    ...
    _this3.hideLoadingDialog();
    if (_this3.props.onScriptError) {
      _this3.props.onScriptError.apply(_this3, args);
    }
  };
  ...
  this.onClosed = function () {
    ...
    if (_this3._isMounted) _this3.setState({ open: false });
    if (_this3.props.closed) {
      _this3.props.closed.apply(_this3, args);
    }
  };
  ...
  this.onOpened = function () {
    ...
    if (_this3.props.opened) {
      _this3.props.opened.apply(_this3, args);
    }
  };

  this.getConfig = function () {
    return ['token', 'source', 'image', 'name', 'description', 'amount', 'locale', 'currency', 'panelLabel', 'zipCode', 'shippingAddress', 'billingAddress', 'email', 'allowRememberMe', 'bitcoin', 'alipay', 'alipayReusable'].reduce(function (config, key) {
      return _extends({}, config, _this3.props.hasOwnProperty(key) && _defineProperty({}, key, _this3.props[key]));
    }, {
      opened: _this3.onOpened,
      closed: _this3.onClosed
    });
  };
  ...
  this.onClick = function () {
    ...
    if (scriptDidError) {
      ...
      _this3.showLoadingDialog();
      _this3.hasPendingClick = true;
    }
  };

  this.handleOnMouseDown = function () {
    _this3.setState({
      buttonActive: true
    });
  };
